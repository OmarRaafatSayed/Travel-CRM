-- Update organization_members role constraint to include all existing roles plus scrum_master
ALTER TABLE organization_members DROP CONSTRAINT IF EXISTS organization_members_role_check;
ALTER TABLE organization_members ADD CONSTRAINT organization_members_role_check CHECK (role IN ('admin', 'member', 'developer', 'scrum_master'));
